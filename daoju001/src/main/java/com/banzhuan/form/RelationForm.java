...
public class RelationForm implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4485419746348788805L;
	private String wxid;
	// 被收藏的id
	...
	/**
	 * @param wxname2 the wxname2 to set
	 */
	...
	/**
	 * @param wxcompany the wxcompany to set
	 */
	...
	/**
	 * @param wxcompany2 the wxcompany2 to set
	 */
