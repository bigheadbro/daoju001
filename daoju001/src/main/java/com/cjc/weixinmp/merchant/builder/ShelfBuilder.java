...
import com.cjc.weixinmp.merchant.bean.ShelfRequest;
import com.cjc.weixinmp.merchant.bean.ShelfRequest.ShelfData;
import com.cjc.weixinmp.merchant.bean.ShelfRequest.ShelfData.ModuleInfo;
import com.cjc.weixinmp.merchant.bean.ShelfRequest.ShelfData.ModuleInfo.GroupInfo;
import com.cjc.weixinmp.merchant.bean.ShelfRequest.ShelfData.ModuleInfo.GroupInfos;
import com.cjc.weixinmp.merchant.bean.ShelfRequest.ShelfData.ModuleInfo.GroupInfo.Filter;
import com.cjc.weixinmp.merchant.bean.ShelfRequest.ShelfData.ModuleInfo.GroupInfos.Group;
...
public class ShelfBuilder extends DataBuilder<ShelfRequest> {
    ...
    private ShelfData getShelfData() {
        if (p.shelfData == null) {
            ...
            p.shelfData.moduleInfoList = new ArrayList<ModuleInfo>();
        }
        return p.shelfData;
    }
    ...
    public static class Shelf2Builder {
        ...
        Shelf2Builder() {
            ...
            m.groupInfos.groups = new ArrayList<Group>();
        }
