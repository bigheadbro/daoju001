...
import com.banzhuan.controller.WeixinController;
 ...
 */
public class AbstractUserOperate {

	private Logger logger = LoggerFactory.getLogger(AbstractUserOperate.class);
