...
import com.cjc.weixinmp.merchant.bean.ExpressTemplate;
import com.cjc.weixinmp.merchant.bean.ExpressTemplate.DeliveryTemplate;
import com.cjc.weixinmp.merchant.bean.ExpressTemplate.DeliveryTemplate.TopFee;
import com.cjc.weixinmp.merchant.bean.ExpressTemplate.DeliveryTemplate.TopFee.Custom;
import com.cjc.weixinmp.merchant.bean.ExpressTemplate.DeliveryTemplate.TopFee.Normal;
...
public class ExpressTemplateBuilder extends DataBuilder<ExpressTemplate> {
    ...
    private List<TopFee> getTopFeeList() {
        if (getDeliveryTemplate().topFee == null) {
            getDeliveryTemplate().topFee = new ArrayList<TopFee>();
        }
    ...
    public static class TopFeeBuilder {
        ...
        public CustomerBuilder addCustomer() {
            ...
            if (topFee.list == null) {
                topFee.list = new ArrayList<Custom>();
            }
